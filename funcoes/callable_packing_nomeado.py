...
preco_bruto = 134.98
preco_final = calc_prec_final(preco_bruto, imposto_x,importado= True)
preco_final = calc_prec_final(preco_final, imposto_y,explosivo= True,fator_mult= 1.5)

print(f'Preço Final R$ {preco_final}')


# Nesta Versão é preciso nomear os parametros
# Parametro Nomeado **
